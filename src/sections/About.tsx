...
export default function About() {
    return(
        <section className='content flex flex-row justify-center w-full text-center font-roboto font-bold leading-relaxed text-xl sm:leading-loose sm:text-2xl lg:text-3xl lg:leading-loose'>
            <h3>
